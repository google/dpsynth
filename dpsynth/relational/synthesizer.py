...
class MultiTableMechanism(api.CalibratedMechanism):
  ...
  def dp_event(self, group_size: int) -> dp_accounting.DpEvent:
    ...
    Args:
      group_size: Maximum records contributed by a single group or user.
