...
class SWIFTMechanismConfig(base.DiscreteMechanismConfig):
  ...
  def _create_mechanism(self, **kwargs) -> 'SWIFTMechanism':
    return SWIFTMechanism(**kwargs)


@dataclasses.dataclass(frozen=True, kw_only=True)
class SWIFTMechanism(base.DiscreteMechanism):
  """Calibrated SWIFTMechanism instance."""

  config: SWIFTMechanismConfig
  _select_rho: float
