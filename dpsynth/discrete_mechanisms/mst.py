...
class MSTMechanismConfig(base.DiscreteMechanismConfig):
  ...
  def _create_mechanism(self, **kwargs) -> 'MSTMechanism':
    return MSTMechanism(**kwargs)


@dataclasses.dataclass(frozen=True, kw_only=True)
class MSTMechanism(base.DiscreteMechanism):
  """Calibrated MSTMechanism instance."""

  config: MSTMechanismConfig
